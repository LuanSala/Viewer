...
package lsa.viewercloudpoints.opengl;
...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private static class GLThreadManager {
        ...
        private void checkGLESVersion() {
            if (! mGLESVersionCheckComplete) {
                try {
                    mGLESVersion = (int)Class.forName("android.os.SystemProperties").getMethod(
                            "getInt",String.class,int.class).invoke(null,"ro.opengles.version",
    ...
    private static boolean mSurfaceDestroyed = false;
}
